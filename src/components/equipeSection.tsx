    ...
    <article className="w-screen min-h-screen p-10 max-md:px-4 bg-sky-700 text-zinc-50 flex justify-around max-lg:flex-wrap pt-16 items-center">
      <div className="bg-slate-900 p-14 pt-28 max-md:pt-14 max-md:pb-5 max-md:px-3 rounded-md max-md:text-center">
        <div className=" -translate-y-10 max-md:-translate-y-5">
          <span className="font-semibold uppercase text-zinc-100">Fale com</span>
          <h2 className="text-4xl font-bold">Nossa Equipe</h2>
        </div>
        <p className="max-w-3xl text-lg">
          Na Recmed, estamos sempre prontos para ajudar! Se você tem alguma dúvida, precisa de informações adicionais ou deseja conversar com um de nossos especialistas, entre em contato conosco. Nossa equipe está disponível para oferecer o suporte que você precisa e responder a todas as suas perguntas.{" "}
          <span className="inline max-md:hidden">
            Se você deseja explorar novas oportunidades de colaboração ou tem interesse em se juntar à nossa equipe, nós também estamos à disposição.
          </span>
        </p>
      ...
      <div>
        <Image
          src={imagecontato}
          alt="Imagem ilustrativa de contato com a equipe"
          width={500}
          height={300}
        />
      </div>
